...
procedure AStarGo(var iMap: TAStarMap);
begin
  AStarCheckBoundaries(iMap); // verifique se o ponto dado está dentro de um obstáculo e movê-lo para o espaço aberto mais próximo
  AStarInit(iMap);
  while true do begin
...
begin
  ...
  AStarGo(AStarMap);  //limite, celulas livres (STAR)
  AStarBuildTrajectory(st_x,st_y,tg_x,tg_y, AStarMap, traj);       // CONSTROI A TRAJETORIA ( FIM- INICIO )
end;
