...
begin
  ...
  while true do begin
    ...
    if iMap.GridState[iMap.TargetPoint.x, iMap.TargetPoint.y] = AStarClosed then break;  // Encontrou o caminho
    // there is no path
    if iMap.HeapArray.count = 0 then break;                                   // não existe caminho
  end;
end;
